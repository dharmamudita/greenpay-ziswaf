...
import { View, Text, StyleSheet, ScrollView, Dimensions, Image, TouchableOpacity, Modal, TouchableWithoutFeedback } from 'react-native';
            ...
            <TouchableWithoutFeedback>
              <View style={dynamicStyles.modalContent}>
                {user?.photo_url ? (
                  ...
                  <LinearGradient colors={[Colors.green[400], Colors.green[600]]} style={dynamicStyles.modalImagePlaceholder}>
...
const getStyles = (colors, isDark) => StyleSheet.create({
  ...
  menuGroup: { 
    ...
    borderWidth: isDark ? 1 : 0,
    borderColor: colors.border,
import { View, Text, StyleSheet, ScrollView, Dimensions, Image, TouchableOpacity, Modal, TouchableWithoutFeedback, useState } from 'react-native';
import { router } from 'expo-router';
import { LinearGradient } from 'expo-linear-gradient';
import { Ionicons } from '@expo/vector-icons';
import { useTranslation } from 'react-i18next';
